                ...
                <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
                    <div class="col">
                        <div class="footer-widget mb-4">
                            <div class="footer-logo mb-4">
                                <a href="#"><img src="<?php echo base_url('');?>assets/images/logo/real_estate_logo_png.png" alt="Image not found!" /></a>
                            </div>
                    ...
                    <div class="col">
                        <div class="footer-widget newslatter-widget mb-4">
                            ...
                            <a href="<?php echo base_url('form')?>" class="btn btn-primary w-100">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-cols-md-2 row-cols-1">
                    ...
                    <div class="col">
                        <ul class="line-menu float-end list-color-gray">
                            <li><a href="<?php echo base_url('terms'); ?>">Privacy & Policy </a></li>
                            <li>|</li>
                        ...
                        <div class="row row-cols-xl-2 row-cols-1">
                            <div class="col">
                                <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom m-2">
                                    ...
                                    <a href="#"><img class="w-100" src="<?php echo base_url(''); ?>assets/images/property/2.png" alt=""></a>
                            ...
                            <div class="col">
                                <div class="property_text transation py-3 pe-3">
                                    ...
                                    <div class="d-flex align-items-center post-meta mt-2 py-3 border-top">
                                        <div class="agent">
                                            <a href="#" class="d-flex text-general align-items-center"><img class="rounded-circle me-2" src="<?php echo base_url('assets/images/team/1.jpg'); ?>" alt="avata"><span>Ali Tufan</span></a>
                                        </div>
    ...
    <script src="<?php echo base_url(''); ?>assets/js/range/tmpl.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/range/jquery.dependClass.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/range/draggable.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/range/jquery.slider.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/wow.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/mixitup.min.js"></script>
    <script src="<?php echo base_url(''); ?>assets/js/paraxify.js"></script>
